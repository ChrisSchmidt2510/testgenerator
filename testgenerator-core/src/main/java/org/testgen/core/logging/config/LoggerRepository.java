...
public final class LoggerRepository
{
...

  {
    ...
    Configuration manipulationConfig = new Configuration("de.nvg.agent.classdata.modification", Level.ERROR,
        agentAppender);
    Configuration analysisConfig = new Configuration("de.nvg.agent.classdata.analysis", Level.INFO,
        agentAppender);
    Configuration transformerConfig = new Configuration("de.nvg.agent.transformer", Level.INFO,
        agentAppender);
