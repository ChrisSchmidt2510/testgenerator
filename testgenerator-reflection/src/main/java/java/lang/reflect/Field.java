...
public final class Field extends AccessibleObject implements Member {
	...
	/**
	 * Package-private routine (exposed to java.lang.Class via ReflectAccess) which
	 * returns a copy of this Field. The copy's "root" field points to this Field.
	 */
	Field copy() {
	 ...
	 *
	 * @return true if and only if this field is a synthetic field as defined by the
	...
	public Class<?> getType() {
		if (ClassExtension.isProxifiedClass(clazz)) {
			...
			return modifiedType != null ? modifiedType : type;
		}
	...
	private void getModifiedType() {
		...
		if (ClassExtension.isProxifiedClass(clazz)) {
			...
			if (!(isPublic && isFinal && isStatic)) {
				modifiedType = classData.getClassOfField(name);
			}
		}
	}
	 ...
	 *
	 * <p>
	 * If the {@code Type} is a parameterized type, the {@code Type} object returned
	 ...
	 *
	 * @return a {@code Type} object that represents the declared type for the field
	 *         represented by this {@code Field} object
	 * @throws GenericSignatureFormatError         if the generic field signature
	 *                                             does not conform to the format
	 *                                             specified in <cite>The
	 *                                             Java&trade; Virtual Machine
	 *                                             Specification</cite>
	 * @throws TypeNotPresentException             if the generic type signature of
	 *                                             the underlying field refers to a
	 *                                             non-existent type declaration
	 * @throws MalformedParameterizedTypeException if the generic signature of the
	 *                                             underlying field refers to a
	...
	/**
	 * Compares this {@code Field} against the specified object. Returns true if the
	 * objects are the same. Two {@code Field} objects are the same if they were
	 * declared by the same class and have the same name and type.
	 */
	@Override
	 ...
	 * exclusive-or of the hashcodes for the underlying field's declaring class name
	 * and its name.
	 */
	@Override
	public int hashCode() {
	 ...
	 * modifiers for the field, if any, followed by the field type, followed by a
	 * space, followed by the fully-qualified name of the class declaring the field,
	 ...
	 *
	 * <p>
	 * The modifiers are placed in canonical order as specified by "The Java
	 * Language Specification". This is {@code public}, {@code protected} or
	 * {@code private} first, and then other modifiers in the following order:
	 * {@code static}, {@code final}, {@code transient}, {@code volatile}.
	 *
	 ...
	 * generic field type, followed by a space, followed by the fully-qualified name
	 * of the class declaring the field, followed by a period, followed by the name
	 * of the field.
	 *
	 * <p>
	 * The modifiers are placed in canonical order as specified by "The Java
	 ...
	 * {@code NullPointerException}. If the specified object is not an instance of
	 * the class or interface declaring the underlying field, the method throws an
	 * {@code IllegalArgumentException}.
	 *
	 * <p>
	 * If this {@code Field} object is enforcing Java language access control, and
	 * the underlying field is inaccessible, the method throws an
	 * {@code IllegalAccessException}. If the underlying field is static, the class
	 * that declared the field is initialized if it has not already been
	 * initialized.
	 *
	 * <p>
	 * Otherwise, the value is retrieved from the underlying instance or static
	 * field. If the field has a primitive type, the value is wrapped in an object
	 * before being returned, otherwise it is returned as is.
	 *
	 * <p>
	 ...
	 *                                        instance of the class or interface
	 *                                        declaring the underlying field (or a
	 *                                        subclass or implementor thereof), or
	 *                                        if the field value cannot be converted
	 *                                        to the type {@code boolean} by a
	 *                                        widening conversion.
	 * @exception NullPointerException        if the specified object is null and
	 *                                        the field is an instance field.
	 * @exception ExceptionInInitializerError if the initialization provoked by this
	 ...
	 *                                        subclass or implementor thereof), or
	 *                                        if the field value cannot be converted
	 *                                        to the type {@code byte} by a widening
	 *                                        conversion.
	 * @exception NullPointerException        if the specified object is null and
	 *                                        the field is an instance field.
	 * @exception ExceptionInInitializerError if the initialization provoked by this
	 ...
	 *                                        subclass or implementor thereof), or
	 *                                        if the field value cannot be converted
	 *                                        to the type {@code char} by a widening
	 *                                        conversion.
	 * @exception NullPointerException        if the specified object is null and
	 *                                        the field is an instance field.
	 * @exception ExceptionInInitializerError if the initialization provoked by this
	 ...
	 *                                        subclass or implementor thereof), or
	 *                                        if the field value cannot be converted
	 *                                        to the type {@code int} by a widening
	 *                                        conversion.
	 * @exception NullPointerException        if the specified object is null and
	 *                                        the field is an instance field.
	 * @exception ExceptionInInitializerError if the initialization provoked by this
	 ...
	 *                                        subclass or implementor thereof), or
	 *                                        if the field value cannot be converted
	 *                                        to the type {@code long} by a widening
	 *                                        conversion.
	 * @exception NullPointerException        if the specified object is null and
	 *                                        the field is an instance field.
	 * @exception ExceptionInInitializerError if the initialization provoked by this
	 ...
	 * object argument to the specified new value. The new value is automatically
	 ...
	 *
	 * <p>
	 * If the underlying field is static, the {@code obj} argument is ignored; it
	 * may be null.
	 *
	 * <p>
	 * Otherwise the underlying field is an instance field. If the specified object
	 * argument is null, the method throws a {@code NullPointerException}. If the
	 ...
	 * succeeded for this {@code Field} object and the field is non-static. Setting
	 * a final field in this way is meaningful only during deserialization or
	 * reconstruction of instances of classes with blank final fields, before they
	 * are made available for access by other parts of a program. Use in any other
	 * context may have unpredictable effects, including cases in which other parts
	 * of a program continue to use the original value of this field.
	 *
	 * <p>
	 ...
	 * attempt fails, the method throws an {@code IllegalArgumentException}.
	 *
	 * <p>
	 * If, after possible unwrapping, the new value cannot be converted to the type
	 * of the underlying field by an identity or widening conversion, the method
	 ...
	 *
	 * <p>
	 * If the field is hidden in the type of {@code obj}, the field's value is set
	 ...
	 * @exception IllegalAccessException      if this {@code Field} object is
	 *                                        enforcing Java language access control
	 *                                        and the underlying field is either
	...
	/**
	 * Sets the value of a field as a {@code boolean} on the specified object. This
	 * method is equivalent to {@code set(obj, zObj)}, where {@code zObj} is a
	 * {@code Boolean} object and {@code zObj.booleanValue() == z}.
	 *
	 * @param obj the object whose field should be modified
	...
	/**
	 * Sets the value of a field as a {@code short} on the specified object. This
	 * method is equivalent to {@code set(obj, sObj)}, where {@code sObj} is a
	 * {@code Short} object and {@code sObj.shortValue() == s}.
	 *
	 * @param obj the object whose field should be modified
	...
	/**
	 * Sets the value of a field as a {@code float} on the specified object. This
	 * method is equivalent to {@code set(obj, fObj)}, where {@code fObj} is a
	 * {@code Float} object and {@code fObj.floatValue() == f}.
	 *
	 * @param obj the object whose field should be modified
	...
	/**
	 * Sets the value of a field as a {@code double} on the specified object. This
	 * method is equivalent to {@code set(obj, dObj)}, where {@code dObj} is a
	 * {@code Double} object and {@code dObj.doubleValue() == d}.
	 *
	 * @param obj the object whose field should be modified
	 ...
	 * 
	 * @return an object representing the declared type of the field represented by
	 *         this Field
	 *
	 * @since 1.8
	 */
	public AnnotatedType getAnnotatedType() {
		return TypeAnnotationParser.buildAnnotatedType(getTypeAnnotationBytes0(),
				sun.misc.SharedSecrets.getJavaLangAccess().getConstantPool(getDeclaringClass()), this,
				getDeclaringClass(), getGenericType(), TypeAnnotation.TypeAnnotationTarget.FIELD);
	}
}
