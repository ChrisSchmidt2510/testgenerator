...
public abstract class BootstrapMethodCreator
{
   ...
   * 
   */
  public BootstrapMethodCreator(ClassFile classFile, ConstPool constantPool)
  {
  ...
  public int create(InvocationType invocationType, String className, String methodName)
  {
    ...
    int bootstrapMethodIndex = constantPool.addMethodrefInfo(
        constantPool.addClassInfo(BOOTSTRAP_METHOD_CLASS), BOOTSTRAP_METHOD_NAME, BOOTSTRAP_METHOD_DESC);
    ...
    int indyTypedMethodTypeIndex = constantPool
        .addMethodTypeInfo(constantPool.addUtf8Info(getTypedMethodType()));
    ...
    {
      classFile
          .addAttribute(new BootstrapMethodsAttribute(constantPool, new BootstrapMethod[] {bootstrapMethod}));
    }
