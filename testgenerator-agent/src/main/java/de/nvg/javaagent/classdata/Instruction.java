...
public class Instruction {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(name, other.name) && opcode == other.opcode && Objects.equals(type, other.type);
	}
	...
	public static class Builder {
		...
		public Instruction build() {
			Instruction bytecode = new Instruction(codeArrayIndex, opcode, localVariableIndex, type, name, classRef);
