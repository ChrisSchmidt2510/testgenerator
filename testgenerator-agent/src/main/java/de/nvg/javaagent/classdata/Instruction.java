...
public class Instruction
{
  ...
  private Instruction(int codeArrayIndex, int opcode, int localVariableIndex, String type, String name,
                      String classRef)
  {
  ...
  public boolean equals(Object obj)
  {
    ...
    return codeArrayIndex == other.codeArrayIndex && Objects.equals(name, other.name)
           && opcode == other.opcode && Objects.equals(type, other.type);
  }
  ...
  public static class Builder
  {
    ...
    {
      Instruction bytecode = new Instruction(codeArrayIndex, opcode, localVariableIndex, type, name,
          classRef);
