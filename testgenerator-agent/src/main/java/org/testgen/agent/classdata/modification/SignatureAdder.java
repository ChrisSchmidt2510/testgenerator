...
public class SignatureAdder {
	...
	public static int add(Bytecode code, SignatureData signature, Wrapper<Integer> localVariableCounter) {
		...
		code.add(Opcode.DUP);
		code.addLdc(code.getConstPool().addClassInfo(BytecodeUtils.cnvDescriptorToJvmName(signature.getType())));
