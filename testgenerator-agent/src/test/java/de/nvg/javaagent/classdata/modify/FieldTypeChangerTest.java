...
public class FieldTypeChangerTest extends TestHelper
{
  ...
  @Test
  public void testOverrideFieldAccess2()
  ...
  @Test
  public void testChangeFieldInitialization()
    throws NotFoundException,
    BadBytecode
  {
    ...
    FieldData sparteID = new FieldData.Builder().withName("sparteID").withDataType("java.lang.Integer")
        .build();
    FieldData bezeichner = new FieldData.Builder().withName("bezeichner").withDataType("java.lang.String")
        .build();

    FieldTypeChanger fieldTypeChanger = new FieldTypeChanger(Arrays.asList(sparteID, bezeichner),
        constantPool, ctClass);
